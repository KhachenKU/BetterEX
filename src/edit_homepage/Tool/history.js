        ...
        uploadTask.on('state_changed',
            ...
            () => {
                ...
                storage.ref('promotion').child(image.name).getDownloadURL().then(url => {
                    ...
                    db.collection('Mission').doc('Mission').set({
                        Link: url
            ...
            <div >
              <h2> Mission </h2>
                <div style={{ padding: 30 }} >
                    <form id="promo3">
                        <Button outline color="secondary" onClick={this.toggle.bind(this)}  style={{ height: 400, width:700 }}>
                            <center>
                                <img src={this.state.url || Plus} alt="Uploaded images"  style={{ height: 380 }} />
                            </center>
                        </Button>
                    </form>
